...
/**
 * Conic-gradient lamp container, retuned from the original cyan/slate-950
 * reference to the cream + Anthropic-orange palette of this site. Used by
 * `BootLoader` as a one-time loading screen, but exported as a reusable
 * primitive so it can wrap any hero text.
 */
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        <motion.div
          ...
          style={{
            backgroundImage:
              "conic-gradient(from 70deg at center top, #CC785C, transparent, transparent)",
          }}
        ...
        <motion.div
          ...
          style={{
            backgroundImage:
              "conic-gradient(from 290deg at center top, transparent, transparent, #CC785C)",
          }}
